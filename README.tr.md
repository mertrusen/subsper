...
4. **Altyazı Oluştur → Ayarlar** içinde konuşma dilini ve gerekirse konuşmanın bulunduğu ses track'ini seç. Otomatik kaynak önce video sesini kullanır; ayrı mikrofon için doğru A1/A2 track'ini seç. Aynı yerde satır önizlemesinin fontunu listeden seçip puntoyu, kalınlığı ve altyazı kutusunun genişliğini ayarla. Metin seçilen fontla ölçülür ve olası üçüncü satır işaretlenir. Premiere farklı dizebilir; bu kesin sınır değil, rehberdir. İstediğin kelimeye tıklayarak böl. **↑** ile veya altyazı numarasını komşu altyazıya sürükleyerek birleştir. **Cmd/Ctrl+Z** ile geri al. Önizleme gönderimi engellemez.
